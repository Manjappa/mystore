...
import com.manjappa.store.entities.OrderItem;
import com.manjappa.store.entities.PaymentStatus;
...
public class StripePaymentGateway implements PaymentGateway{
    ...
    public CheckoutSession createCheckoutSession(Order order) {
        try {
            ...
            SessionCreateParams.Builder stripeBuilder = SessionCreateParams.builder()
            ...
            order.getItems().forEach( item -> {
                ...
                stripeBuilder.addLineItem(lineItem);
            });

            var session = Session.create(stripeBuilder.build());
